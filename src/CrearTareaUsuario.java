...
public class CrearTareaUsuario extends javax.swing.JFrame {
    ...
    */
    Escalar escalar = new Escalar();
     ...
     /**
    * Instancia de un usuario con datos inicializados predeterminados. 
    */
    ...
    */
    ...
    /**
    * Directorio donde se almacenan las tareas del usuario.
    */
    private String direcTareas = userHome + "\\Taskflow\\Tareas\\";

    /**
    * directorio de la Lista de tareas del usuario. 
    */
    ...
    */
    ...
    /**
     * Constructor de la clase CrearTareaUsuario. Inicializa la interfaz de usuario,
     * escala las imágenes de los componentes y configura las rutas para el almacenamiento de tareas.
     */
    ...
    /**
    * Método que maneja la acción de crear una nueva tarea cuando el usuario presiona el botón de crear tarea.
    * 
    * Este método toma los datos ingresados por el usuario en los campos de texto y los combos de la interfaz,
    * valida que todos los campos necesarios estén completos y correctos, y luego crea una nueva tarea. 
    * La tarea se guarda tanto en un archivo individual como en una lista general de tareas.
    * 
    * Si los datos son incorrectos o incompletos, muestra un mensaje de advertencia al usuario.
    * 
    * @param evt El evento de acción generado por el botón de "Crear Tarea".
    */
    ...
    /**
    * Evento que se activa cuando el usuario hace clic en el campo de texto "TF_Nombre".
    * Si el campo de texto contiene el texto predeterminado "Nombre de la tarea", se borra.
    * 
    * @param evt El evento de acción generado por el clic del mouse en el campo de texto.
    */
    ...
    /**
    * Crea una carpeta y un archivo en el sistema de archivos.
    * 
    * Este método intenta crear una carpeta en la ruta especificada por la variable
    * direcTareas y, si la carpeta no existe, la crea. Después, intenta crear
    * un archivo de texto en la ruta especificada por listaTareas. Si el archivo
    * ya existe, no se crea, y se muestra un mensaje indicando la situación.
    */
