...
/**
 * Clase que representa la ventana de "Mis Tareas", donde se gestionan y visualizan las tareas asignadas al usuario actual.
 */
public class MisTareas extends javax.swing.JFrame {

    /**
     * Objeto de tipo Escalar utilizado en la clase.
     */
    private Escalar escalar = new Escalar();

    /**
     * Representa al usuario actual que está utilizando el sistema.
     */
    private Usuario UsuarioActual = new Usuario();

    /**
     * Directorio de inicio del usuario actual, generalmente la carpeta de usuario en el sistema.
     */
    private String userHome = "C:\\Users\\Cesia\\Desktop";

    /**
     * Ruta completa del archivo que contiene la lista de tareas del usuario.
     */
    private String fileListaTareas = userHome + "\\Taskflow\\Tareas\\Usuario";

    /**
     * Directorio donde se encuentran las tareas del usuario.
     */
    ...
    /**
     * Lista que almacena los resultados de la búsqueda de tareas.
     */
    public ArrayList<Tarea> listaBuscar = new ArrayList<>();

    /**
     * Nombre que se utiliza como criterio de búsqueda para las tareas.
     */
    public String nombre = "";

    /**
     * Prioridad que se utiliza como criterio de búsqueda para las tareas.
     */
    public String prioridad = "";

    /**
     * Estado que se utiliza como criterio de búsqueda para las tareas.
     */
    public String estado = "";

    /**
     * Índice utilizado para rastrear la posición actual en la lista de tareas.
     */
    public int indice = 0;

    /**
     * Contador general de tareas, usado para realizar operaciones de control o verificación.
     */
    public int cont = 0;
    /**
    * Constructor de la clase MisTareas. Inicializa los componentes de la interfaz de usuario,
    * ajusta las imágenes de los elementos visuales y carga las tareas del usuario actual.
    * 
    * Este constructor también se encarga de filtrar las tareas que no están completas
    * y de mostrar la lista de tareas en una tabla.
    */
    public MisTareas() {
        initComponents();
    ...
    /**
    * Método que obtiene una tarea específica de la lista de tareas,
    * buscando por el número y nombre de la tarea.
    *
    * @param buscar La tarea que se desea buscar en la lista.
    * @return La tarea encontrada que coincide con el número y nombre de la tarea proporcionada.
    */
    ...
    /**
    * Método que actualiza la lista de tareas, obteniendo las tareas desde el archivo
    * y filtrando las que no están completas.
    * Después, se llena la tabla con las tareas filtradas o se realiza una búsqueda,
    * dependiendo de los filtros establecidos por el usuario.
    */
    ...
    /**
    * Método que vacía todas las filas de la tabla.
    * Elimina las filas de la tabla desde la última hacia la primera.
    */
    ...
    /**
    * Método que llena la tabla con las tareas que están en la lista proporcionada.
    * Para cada tarea, se crea una nueva fila con los datos correspondientes.
    *
    * @param lista La lista de tareas que se utilizará para rellenar la tabla.
    */
    ...
    /**
    * Filtra las tareas de la lista según los criterios de búsqueda, como el nombre, la prioridad y el estado.
    * 
    * @param textoBusqueda El texto que se usará para buscar por nombre de tarea.
    ...
    * @return Una nueva lista de tareas que coinciden con los criterios de búsqueda.
    */
    ...
    /**
    * Realiza una búsqueda de tareas utilizando los filtros seleccionados por el usuario (nombre, prioridad y estado).
    * Luego, muestra los resultados en una tabla.
    * Si no se encuentran tareas que coincidan, muestra un mensaje de advertencia.
    */
    ...
    private void initComponents() {
        ...
        Pantalla.add(lblEsq, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 50, 40));
        ...
        Pantalla.add(CBEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, 140, -1));
        ...
        Pantalla.add(CBPrioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, -1, -1));
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón de búsqueda (BTBuscar).
    * Llama al método de búsqueda de tareas con los criterios seleccionados por el usuario.
    *
    * @param evt El evento de presionar el mouse sobre el botón de búsqueda.
    */
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el campo de texto de búsqueda (TFBuscar).
    * Si el campo contiene el texto predeterminado "Buscar por nombre", lo borra para permitir la entrada de texto.
    *
    * @param evt El evento de presionar el mouse sobre el campo de texto de búsqueda.
    */
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón de reiniciar (BTReiniciar).
    * Este método restablece los valores de los filtros, vacía y vuelve a llenar la tabla con todas las tareas,
    * y restaura los valores predeterminados en los campos de búsqueda y filtros.
    *
    * @param evt El evento de presionar el mouse sobre el botón de reiniciar.
    */
    ...
    /**
    * Método que se ejecuta cuando se selecciona un nuevo valor en el combo box de estado (CBEstado).
    * Este método no tiene implementación aún, pero está destinado a manejar la acción de selección de un nuevo valor.
    *
    * @param evt El evento de selección en el combo box de estado.
    */
    ...
    /**
    * Método que se ejecuta cuando el estado del item en el combo box de estado cambia (CBEstado).
    * Si se selecciona un nuevo valor, se actualiza la búsqueda de tareas.
    *
    * @param evt El evento que indica que el estado del item ha cambiado.
    */
    ...
    private void BTCrearTareaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTCrearTareaMousePressed
        CrearTareaPropia ventana = new CrearTareaPropia();
        ventana.setVisible(true);
        this.dispose();
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón de vaciar tareas (BTVaciar).
    * Este método elimina todas las tareas de la lista, tanto del archivo como de la interfaz de usuario,
    * y luego actualiza la lista de tareas en la tabla. También restablece los campos de búsqueda y los filtros.
    *
    * @param evt El evento de presionar el mouse sobre el botón de vaciar tareas.
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MisTareas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    /**
    * Método que agrega una fila con botones de acción (editar, eliminar, ver) en la tabla.
    * La fila contiene los datos de la tarea, y cada botón realiza una acción correspondiente
    * al evento (editar, eliminar, ver). Además, asigna un editor y un renderer para la columna de acciones.
    * 
    * @param rowData Datos de la fila que se agregarán a la tabla.
    */
    ...
    TableActionEvent event = new TableActionEvent() {
        ...
        public void onEdit(int row) {
            ...
            if (selectedRow != -1) {
                ...
                EditarTareaPropia ventana= new EditarTareaPropia(MisTareas.this);
