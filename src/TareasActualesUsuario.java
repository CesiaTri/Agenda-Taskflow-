...
import raven_cell2.TableActionCellEditor;
import raven_cell2.TableActionCellRender;
import raven_cell2.TableActionEvent;

/**
 * La clase TareasActualesUsuario extiende de javax.swing.JFrame y se utiliza para gestionar las tareas actuales
 * de un usuario dentro de una interfaz gráfica. Esta clase incluye variables para el manejo de la lista de tareas,
 * así como varias operaciones relacionadas con la visualización y manipulación de las tareas del usuario.
 */
public class TareasActualesUsuario extends javax.swing.JFrame {

    /**
     * Instancia de la clase Escalar, utilizada para operaciones específicas de escalamiento.
     */
    Escalar escalar = new Escalar();

    /**
     * Representa el usuario actual cuya lista de tareas se está gestionando.
     */
    private Usuario UsuarioActual = new Usuario();

    /**
     * Ruta al directorio de inicio del usuario en el sistema operativo.
     */
    private String userHome = "C:\\Users\\Cesia\\Desktop";

    /**
     * Ruta al archivo de texto donde se almacena la lista de tareas del usuario.
     */
    private String fileListaTareas = userHome + "\\Taskflow\\Tareas\\ListaTareas.txt";

    /**
     * Ruta al directorio donde se almacenan las tareas.
     */
    private String direcTareas = userHome + "\\Taskflow\\Tareas";

    /**
     * Lista de todas las tareas asociadas al usuario actual.
     */
    public ArrayList<Tarea> lista;

    /**
     * Lista de tareas que se han filtrado o buscado por algún criterio.
     */
    public ArrayList<Tarea> listaBuscar = new ArrayList<>();

    /**
     * Nombre del usuario actual que se utiliza para la gestión de tareas.
     */
    public String nombre = "";

    /**
     * Prioridad de las tareas a buscar o filtrar.
     */
    public String prioridad = "";

    /**
     * Estado de las tareas a buscar o filtrar (por ejemplo, "Pendiente", "Completada").
     */
    public String estado = "";

    /**
     * Índice de la tarea actual seleccionada en la lista.
     */
    public int indice = 0;
    
    /**
    * Constructor de la clase TareasActualesUsuario.
    * Inicializa los componentes de la interfaz gráfica, configura las imágenes 
    * de los diferentes elementos visuales en la ventana y establece el usuario 
    * actual. Además, carga la lista de tareas del usuario y la presenta en una tabla.
    */
    ...
    /**
    * Filtra y muestra las tareas con estado "En progreso" en la tabla.
    * Este método limpia la tabla, establece el estado a "En progreso", 
    * y luego recorre la lista de tareas para mostrar solo aquellas que 
    * están en progreso.
    */
    ...
    // Iteramos sobre el ArrayList usando su tamaño (size())
        ...
        for (int aux = 0; aux < lista.size(); aux++) {
            if(lista.get(aux).getEstado().equals("En progreso")){
    ...
    /**
    * Filtra y muestra las tareas con estado "Por hacer" en la tabla.
    * Este método limpia la tabla, establece el estado a "Por hacer", 
    * y luego recorre la lista de tareas para mostrar solo aquellas que 
    * están por hacer.
    */
    ...
    // Iteramos sobre el ArrayList usando su tamaño (size())
        ...
        estado="Por hacer";
        for (int aux = 0; aux < lista.size(); aux++) {
            if(lista.get(aux).getEstado().equals("Por hacer")){
                Object[] newRow = new Object[] {
                    lista.get(aux).getNumeroTarea(),     
                    lista.get(aux).getNombre(), 
                    lista.get(aux).getPrioridad(),
    ...
    /**
    * Filtra y muestra las tareas con estado "Completada" en la tabla.
    * Este método limpia la tabla, establece el estado a "Completada", 
    * y luego recorre la lista de tareas para mostrar solo aquellas que 
    * están completadas.
    */
    ...
    // Iteramos sobre el ArrayList usando su tamaño (size())
        ...
        estado="Completada";
        for (int aux = 0; aux < lista.size(); aux++) {
            if(lista.get(aux).getEstado().equals("Completada")){
                Object[] newRow = new Object[] {
                    lista.get(aux).getNumeroTarea(),     
                    lista.get(aux).getNombre(), 
                    lista.get(aux).getPrioridad(),
    ...
    /**
    * Busca una tarea en la lista de tareas basándose en el número de tarea y el nombre.
    * 
    * @param buscar La tarea que se quiere buscar en la lista.
    * @return La tarea encontrada, si existe en la lista; de lo contrario, devuelve una tarea vacía.
    */
    ...
    /**
    * Actualiza la lista de tareas, recargando las tareas del usuario y actualizando la tabla
    ...
    */
    ...
    /**
    * Rellena la tabla con los datos de la lista de tareas proporcionada.
    * 
    ...
    */
    ...
    /**
    * Filtra las tareas de la lista según los criterios de búsqueda (nombre, prioridad y estado).
    * 
    * @param textoBusqueda El texto que se busca en los nombres de las tareas.
    * @param prioridadSeleccionada La prioridad seleccionada para filtrar.
    * @param estadoSeleccionado El estado de la tarea seleccionado para filtrar.
    * @param lista La lista de tareas a filtrar.
    * @return Una lista con las tareas que coinciden con los filtros aplicados.
    */
    ...
    /**
    * Realiza la búsqueda de tareas en función de los filtros seleccionados (nombre, prioridad, estado).
    * Si se encuentran resultados, los muestra en la tabla. Si no, muestra un mensaje de error.
    */
    ...
    /**
    * Obtiene las tareas asociadas al usuario actual desde un archivo en el sistema.
    * 
    * @return Una lista de tareas que están asignadas al usuario actual.
    */
    ...
    */
    ...
    /**
    * Evento que se dispara cuando el usuario presiona el mouse sobre el campo de texto de búsqueda.
    * Si el texto en el campo de búsqueda es "Buscar por nombre", se borra ese texto para permitir al usuario 
    * ingresar un nuevo texto de búsqueda.
    * 
    * @param evt El evento de mouse que se produce al presionar el mouse sobre el campo de texto.
    */
    ...
    /**
    * Evento que se dispara cuando el usuario presiona el mouse sobre el botón de reiniciar.
    * Este método reinicia la tabla y los filtros de búsqueda, restaurando el estado inicial de la interfaz.
    * 
    * - Vacía la tabla.
    * - Vuelve a llenar la tabla con todas las tareas disponibles.
    * - Restaura los valores predeterminados en los campos de búsqueda y los filtros (nombre, prioridad y estado).
    * 
    * @param evt El evento de mouse que se produce al presionar el botón de reiniciar.
    */
    ...
    /**
    * Evento que se dispara cuando el usuario selecciona un ítem en el combo box de estado.
    * Si el estado seleccionado cambia, se llama al método para buscar las tareas correspondientes.
    * 
    * @param evt El evento de cambio de estado en el combo box.
    */
    ...
    /**
    * Evento que se dispara cuando el usuario selecciona un ítem en el combo box de prioridad.
    * Si la prioridad seleccionada cambia, se llama al método para buscar las tareas correspondientes.
    * 
    * @param evt El evento de cambio de prioridad en el combo box.
    */
    ...
    /**
    * Agrega una fila a la tabla con los datos proporcionados y configura la columna de acciones
    * para que contenga botones con funcionalidades de editar y ver. Al hacer clic en los botones,
    * se ejecutarán los eventos correspondientes, como la edición o visualización de los detalles
    * de una tarea.
    * 
    * @param rowData Los datos que se agregan a la nueva fila de la tabla. Estos datos corresponden
    *                a los diferentes atributos de una tarea, como el número de tarea, el nombre,
    *                la prioridad, y el estado, entre otros.
    */
    ...
    table.getColumnModel().getColumn(4).setCellRenderer(new raven_cell2.TableActionCellRender());
    table.getColumnModel().getColumn(4).setCellEditor(new raven_cell2.TableActionCellEditor(event));
}
