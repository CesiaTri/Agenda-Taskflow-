...
public class PerfilUsuario extends javax.swing.JFrame {
     ...
     * en los componentes de la interfaz gráfica.
     */
    Escalar escalar = new Escalar();

    /**
     * Instancia del objeto Usuario que representa al usuario actual cuyo perfil se está mostrando.
     */
    private Usuario UsuarioActual = new Usuario();
    
    /**
    * Constructor de la clasePerfilUsuario.
    * Inicializa los componentes de la interfaz gráfica, ajusta la ubicación de la ventana,
    * escala las imágenes mostradas en los JLabel, y obtiene los datos del usuario actual
    * para mostrarlos en los JLabel correspondientes.
    */
    ...
    private void PR_EditarPerfilMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PR_EditarPerfilMousePressed
        EditarPerfilUsuario ventana = new EditarPerfilUsuario();
