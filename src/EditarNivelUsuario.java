...
public class EditarNivelUsuario extends javax.swing.JFrame {
    ...
    /**
     * Instancia de la clase Escalar que se utiliza para escalar las imágenes en la interfaz de usuario.
     */
    ...
    /**
     * Objeto Usuario que representa al usuario actual cuyos datos se están editando.
     */
    public Usuario UsuarioActual;

    /**
     * Lista de usuarios cargados desde el archivo, que se usa para acceder y modificar los datos de los usuarios.
     */
    public ArrayList<Usuario> lista;

    /**
     * Índice del usuario que se está editando dentro de la lista de usuarios.
     */
    public int indice = 0;

    /**
     * Instancia de la clase Usuarios, que maneja la gestión de usuarios.
     */
    private Usuarios usuarios;
    
    /**
     * Establece el índice del usuario a editar.
     * @param ind El índice del usuario en la lista de usuarios.
     */
    ...
    /**
     * Establece los datos del usuario que se va a editar y los muestra en los componentes gráficos.
     * @param usuario El objeto Usuario que contiene la información del usuario a editar.
     */
    ...
    /**
     * Establece la lista de usuarios, generalmente utilizada para cargar los usuarios desde un archivo.
     * @param aux La lista de usuarios a establecer.
     */
    ...
    /**
     * Constructor que inicializa la interfaz gráfica, escala las imágenes y establece la instancia de la clase Usuarios.
     * @param usuarios El objeto Usuarios que maneja la lista de usuarios y sus acciones.
     */
    ...
    /**
    * Acción que se ejecuta cuando se hace clic en el botón "Guardar" para actualizar el nivel del usuario.
    * 
    * @param evt El evento generado por el clic en el botón "Guardar".
    */
    ...
    /**
    * Acción que se ejecuta cuando se hace clic en el botón "Cancelar".
    * Cierra la ventana
    * 
    * @param evt El evento generado por el clic en el botón "Cancelar".
    */
