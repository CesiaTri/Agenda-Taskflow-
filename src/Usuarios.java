...
/**
 * Clase que representa la ventana principal de la aplicación para gestionar y visualizar los usuarios.
 */
public class Usuarios extends javax.swing.JFrame {

    /**
    * Instancia de la clase Escalar, utilizada para realizar operaciones de escalado de imágenes.
    */
    Escalar escalar = new Escalar();

    /**
    * Ruta del directorio de inicio del usuario actual, se utiliza para localizar la carpeta de usuario en el sistema.
    */
    private String userHome = "C:\\Users\\Cesia\\Desktop";

    /**
    * Ruta completa al archivo de usuarios, el cual se encuentra dentro de la carpeta "Taskflow" en el escritorio del usuario.
    */
    private String fileUsuarios = userHome + "\\Taskflow\\Usuarios.txt";

    /**
    * Lista que almacena los usuarios que existen en el sistema, de tipo ArrayList de Usuario.
    */
    public ArrayList<Usuario> lista;

    /**
    * Objeto de la clase Usuario que representa al usuario actual, que ha iniciado sesión en el sistema.
    */
    private Usuario UsuarioActual = new Usuario();

    /**
    * Variable entera que se utiliza como índice para acceder a los elementos de la lista de usuarios o tareas.
    */
    public int indice = 0;

    /**
    * Cadena de texto que representa el nombre de usuario actual.
    */
    private String usuario = "";

    /**
    * Contador entero que se usa para realizar operaciones de control o como índice adicional dentro de la lógica de la aplicación.
    */
    public int cont = 0;
    
    /**
     * Constructor de la clase Usuarios. Inicializa los componentes gráficos de la interfaz, 
     * configura las imágenes de la interfaz usando la clase Escalar y carga la lista de usuarios 
     * a partir del archivo especificado en fileUsuarios.
     */
    public Usuarios() {
        initComponents();
    ...
    /**
    * Busca un usuario en la lista de usuarios y muestra los detalles en una tabla.
    * Si el usuario especificado no se encuentra en la lista, muestra un mensaje de error.
    * El método también limpia la tabla antes de realizar la búsqueda y rellena la tabla con los resultados.
    */
    ...
    /**
    * Evento que se ejecuta cuando se presiona el botón de búsqueda.
    * Obtiene el texto ingresado en el campo de búsqueda y llama al método `buscarUsuario()` para realizar la búsqueda
    * si el texto no está vacío ni es igual a "Buscar usuario".
    * 
    * @param evt El evento de mouse que se genera cuando se hace clic en el botón de búsqueda.
    */
    ...
    /**
    * Evento que se ejecuta cuando se presiona el botón de reiniciar.
    * Este método limpia la tabla, vuelve a rellenarla con los datos originales de la lista de usuarios,
    * y restablece el texto del campo de búsqueda a su valor predeterminado "Buscar usuario".
    * 
    * @param evt El evento de mouse que se genera cuando se hace clic en el botón de reiniciar.
    */
    ...
    /**
    * Agrega una nueva fila a la tabla con los datos proporcionados y configura los botones de acción
    * (Editar, Eliminar y Ver) en la columna correspondiente.
    * 
    * @param rowData Un arreglo de objetos que contiene los datos de la fila a agregar en la tabla.
    *                Estos datos incluyen información sobre el usuario, como ID, nombre y correo electrónico.
    */
    ...
    /**
    * Establece la lista de usuarios que se utilizará en la vista y actualiza la tabla
    * de acuerdo con la lista proporcionada. Si no se especifica un filtro de búsqueda,
    * se muestra toda la lista de usuarios; de lo contrario, se realiza la búsqueda.
    * 
    * @param aux Lista de objetos de tipo Usuario que contiene la información de los usuarios.
    */
    ...
    /**
    * Busca un usuario en la lista de usuarios basándose en el ID y nombre de usuario proporcionados.
    * Si encuentra una coincidencia, actualiza el índice y retorna el usuario correspondiente.
    * 
    * @param buscar Objeto Usuario que contiene el ID y nombre de usuario a buscar.
    * @return El usuario encontrado que coincide con los criterios de búsqueda.
    */
    ...
    /**
    * Elimina todas las filas de la tabla para poder actualizarla con nuevos datos.
    * Este método se utiliza para limpiar la tabla antes de agregar nuevas filas.
    */
    ...
    /**
    * Rellena la tabla con los datos de la lista de usuarios proporcionada.
    * Este método recorre la lista de usuarios y agrega cada uno a la tabla con los valores de ID,
    * nombre de usuario, correo y un campo adicional para los botones de acción.
    * 
    * @param lista Lista de objetos Usuario que contiene los datos a mostrar en la tabla.
    */
