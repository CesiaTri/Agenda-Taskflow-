 ...
 * Esta clase permite al usuario modificar su nombre de usuario, correo y contraseña.
 */
public class EditarPerfilUsuario extends javax.swing.JFrame {
    ...
    */
    ...
    /**
     * Constructor que inicializa la ventana de edición de perfil.
     * Establece el tamaño y posición de los componentes gráficos.
     * 
     * También asigna los valores iniciales a los campos de texto con los datos del usuario actual.
     */
    ...
    /**
    * Método que se ejecuta cuando se hace clic en el botón "Cancelar" en la ventana de edición del perfil.
    * Redirige al usuario a la ventana de su perfil sin guardar cambios y cierra la ventana actual.
    * @param evt
    */
    ...
    /**
    * Método que se ejecuta cuando se hace clic en el botón "Guardar" para actualizar los datos del perfil del usuario.
    * 
    * Valida que los campos de nombre de usuario, correo y contraseñas no estén vacíos y que las contraseñas coincidan.
    * Si los datos son válidos, se actualiza la información del usuario en el archivo y se guarda el usuario actual.
    * Si la actualización es exitosa, se muestra un mensaje de confirmación y se redirige al perfil del usuario.
    */
    ...
    /**
    * Maneja el evento de clic en el campo de texto del nombre de usuario.
    * Borra el valor predeterminado si está presente y asegura que los campos de correo y contraseña tengan valores predeterminados si están vacíos.
    * @param evt El evento de clic en el campo de texto del Usuario.  
    */
    ...
    /**
    * Maneja el evento de clic en el campo de texto del correo electrónico.
    * Si el correo predeterminado está presente, lo borra. 
    * También asegura que los campos de usuario y contraseña tengan valores predeterminados si están vacíos.
    * 
    * @param evt El evento de clic en el campo de texto del correo.
    */
    ...
    /**
    * Maneja el evento de clic en el campo de contraseña.
    * Si la contraseña predeterminada está presente, la borra. 
    * También asegura que los campos de correo electrónico, usuario y la segunda contraseña tengan valores predeterminados si están vacíos.
    * 
    * @param evt El evento de clic en el campo de texto de la contraseña.
    */
    ...
    /**
    * Maneja el evento de clic en el campo de la segunda contraseña.
    * Si la contraseña predeterminada está presente, la borra.
    * Además, asegura que los campos de correo electrónico, usuario y la primera contraseña tengan valores predeterminados si están vacíos.
    * 
    * @param evt El evento de clic en el campo de texto de la segunda contraseña.
    */
