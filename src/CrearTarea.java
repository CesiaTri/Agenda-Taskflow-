...
public class CrearTarea extends javax.swing.JFrame {
    ...
    /**
    * Objeto para escalar las imágenes en la interfaz gráfica.
    */
    Escalar escalar = new Escalar();

    /**
    * Objeto Usuario utilizado para representar un usuario con valores predeterminados.
    */
    public Usuario usuario = new Usuario(0, null, null, null, null);

    /**
    * Ruta del directorio del usuario en el sistema operativo.
    */
    public String userHome = "C:\\Users\\Cesia\\Desktop";

    /**
    * Ruta del directorio donde se almacenan las tareas en el sistema.
    */
    private String direcTareas = userHome + "\\Taskflow\\Tareas";

    /**
    * Ruta del archivo de texto que contiene la lista de tareas.
    */
    private String listaTareas = userHome + "\\Taskflow\\Tareas\\listaTareas.txt";

    /**
    * Objeto Usuario utilizado para obtenerlos datos del usuario que está usando la aplicación.
    */
    private Usuario UsuarioActual = new Usuario();

    /**
    * Ruta del archivo que contiene la información de los usuarios.
    */
    private String fileUsuarios = userHome + "\\Taskflow\\Usuarios.txt";

    /**
    * Lista de usuarios cargados desde el archivo fileUsuarios.
    */
    public ArrayList<Usuario> lista;
    
    /**
     * Constructor de la clase CrearTarea.
     * Inicializa la interfaz gráfica de usuario, escala las imágenes para que se ajusten al tamaño
     * de los componentes, obtiene el usuario actual y llena el ComboBox con los nombres de usuario disponibles.
     */
    public CrearTarea() {
        initComponents();
        ...
        for (int a = 0; a < lista.size(); a++) {
            CBAsignarUsuario.addItem(lista.get(a).getUsuario()); 
        }
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        ...
        PRRegistro.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 170, 40));
        ...
        PRRegistro.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 250, 150, 40));
        ...
        PRRegistro.add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, 220, 40));
        ...
        CBAsignarUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CBAsignarUsuarioActionPerformed(evt);
            }
        });
        PRRegistro.add(CBAsignarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 280, 40));

        jComboBox5.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox5.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        ...
        PRRegistro.add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 70, 40));
        ...
        PRRegistro.add(CBYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 250, 90, 40));
    ...
    /**
    * Método que se ejecuta cuando se hace clic en el botón de "Crear Tarea".
    * Este método valida los campos de entrada, crea una nueva tarea con los datos ingresados
    * y guarda la tarea en la lista y en un archivo individual. 
    * Si alguno de los campos requeridos está vacío o no es válido, se muestra un mensaje de advertencia.
    * Luego de guardar la tarea, los campos se limpian para permitir ingresar una nueva tarea.
    * 
    * @param evt El evento de acción generado al hacer clic en el botón de "Crear Tarea".
    */
    private void BT_CrearTareaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_CrearTareaActionPerformed
        ...
        String prioridades = (String) jComboBox2.getSelectedItem();
        int dias=0;
        ...
        if(!nombreTarea.isEmpty() && !descrip.isEmpty() && !meses.equals("Mes") && !estados.equals("Estado") && !prioridades.equals("Prioridad") && !usuarioAsignado.equals("Asignar Usuario")){
            if(!jComboBox5.getSelectedItem().toString().equals("Dia") && !CBYear.getSelectedItem().toString().equals("Año")){
                ...
                CBAsignarUsuario.setSelectedIndex(0);
            }else
            {
    ...
    /**
    * Método que se ejecuta cuando el campo de texto TF_Nombre es presionado.
    * Si el texto del campo de texto es "Nombre de la tarea", el texto se borra.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_Perfil cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_Perfil cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_Perfil.
    ...
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_Usuarios cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_Usuarios cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_Usuarios.
    ...
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_TareasActuales cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_TareasActuales cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_TareasActuales.
    * Abre la ventana de TareasActuales y cierra la ventana actual.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_MisTareas cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_MisTareas cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_MisTareas.
    * Abre la ventana de MisTareas y cierra la ventana actual.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_Salir cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_Salir cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_Salir.
    ...
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_Inicio cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_Inicio cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_Inicio.
    ...
    */
    ...
    /**
    * Método que cambia el color de fondo del panel PR_Historial cuando el mouse entra en él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que restaura el color de fondo original del panel PR_Historial cuando el mouse sale de él.
    * 
    * @param evt El evento de mouse que generó esta acción.
    */
    ...
    /**
    * Método que se ejecuta cuando se presiona el panel PR_Historial.
    ...
    */
    ...
    private void CBAsignarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBAsignarUsuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CBAsignarUsuarioActionPerformed

    /**
    * Método que se ejecuta cuando se presiona el botón BT_Atras.
    * Abre la ventana de TareasActuales y cierra la ventana actual.
    * 
    * @param evt El evento de acción que generó esta acción.
    */
