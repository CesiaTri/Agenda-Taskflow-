...
public class CrearTareaPropia extends javax.swing.JFrame {
    ...
    /** 
     * Objeto para escalar imágenes en la interfaz de usuario.
     */
    ...
    /** 
     * Ruta predeterminada del directorio de usuario. 
     */
    public String userHome = "C:\\Users\\Cesia\\Desktop";
    
    /** 
     * Ruta donde se almacenan las tareas. 
     */
    private String direcTareas = userHome + "\\Taskflow\\Tareas\\";
    
    /** 
     * Ruta para la lista de tareas del usuario. 
     */
    private String listaTareas = userHome + "\\Taskflow\\Tareas\\";
    
    /** 
     * Objeto que representa al usuario actualmente logueado. 
     */
    private Usuario UsuarioActual = new Usuario();
    
    /**
     * Constructor de la clase. Inicializa los componentes gráficos de la interfaz y configura
     * las rutas de las tareas y la información del usuario.
     * 
     * Además, ajusta las imágenes de la interfaz para que se escalen correctamente y muestra
     * el nombre del usuario actual en el GUI.
     */
    ...
    /**
    * Este método es ejecutado cuando el usuario hace clic en el botón "Crear Tarea".
    * Valida los campos de entrada para asegurarse de que la tarea tenga todos los datos necesarios,
    * luego crea una nueva tarea y la guarda tanto en un archivo individual como en la lista general.
    * Después de guardar, limpia los campos de entrada.
    *
    ...
    */
    ...
    /**
    * Acción de MousePressed en el campo de texto "Nombre de la tarea". Este método limpia el texto
    * predeterminado cuando el usuario hace clic en el campo.
    *
    * @param evt el evento generado por el clic del usuario
    */
    ...
    /**
    * Acción ejecutada cuando se hace clic en el botón "Atras". Abre la ventana de MisTareas y cierra la actual.
    *
    * @param evt el evento generado por el clic en el botón "Atras"
    */
    ...
    /**
    * Crea los archivos necesarios para el almacenamiento de tareas, incluyendo el directorio y el archivo de lista de tareas.
    */
