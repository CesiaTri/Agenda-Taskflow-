...
public class InicioUsuario extends javax.swing.JFrame {
    ...
    /**
     * Representa al usuario actual de la aplicación.
     */
    ...
    /**
     * Ruta al archivo que contiene la lista de tareas.
     */
    private String fileListaTareas = userHome + "\\Taskflow\\Tareas";
    ...
    /**
     * Lista de tareas que maneja la aplicación.
     */
    public ArrayList<Tarea> lista;
    
    /**
    * Constructor de la clase InicioUsuario.
    * Inicializa los componentes gráficos de la interfaz, establece las imágenes a las etiquetas,
    * obtiene el usuario actual, carga la lista de tareas y calcula el número de tareas en diferentes estados.
    */
    public InicioUsuario() {
        ...
        fileListaTareas=fileListaTareas+"\\ListaTareas.txt";
        ...
        for(int a=0;a<lista.size();a++){
            if(lista.get(a).getEstado().equals("Por hacer") && lista.get(a).getUsuarioAsignado().equals(UsuarioActual.getUsuario()))
                porHacer++;
            if(lista.get(a).getEstado().equals("En progreso") && lista.get(a).getUsuarioAsignado().equals(UsuarioActual.getUsuario()))
                enProgreso++;
            if(lista.get(a).getEstado().equals("Completada") && lista.get(a).getUsuarioAsignado().equals(UsuarioActual.getUsuario()))
                completado++;
        }
    ...
    /**
    * Método que maneja el evento de presionar el mouse sobre el componente PR_Por_hacer.
    * Abre una ventana de tareas actuales del usuario y muestra las tareas "Por hacer".
    ...
    */
    ...
    /**
    * Método que maneja el evento de presionar el mouse sobre el componente PR_En_progreso.
    * Abre una ventana de tareas actuales del usuario y muestra las tareas "En progreso".
    * Luego, cierra la ventana actual.
    *
    * @param evt El evento de presionar el mouse.
    */
    ...
    /**
    * Método que maneja el evento de presionar el mouse sobre el componente PR_Completadas.
    * Abre una ventana de tareas actuales del usuario y muestra las tareas "Completadas".
    * Luego, cierra la ventana actual.
    *
    * @param evt El evento de presionar el mouse.
    */
