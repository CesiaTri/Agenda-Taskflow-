 ...
 */
public class EditarTareaPropia extends javax.swing.JFrame {

    /**
     * Instancia de la clase Escalar para realizar operaciones de escalado de tareas.
     */
    Escalar escalar = new Escalar();
    
    /**
     * Objeto Usuario que representa al usuario actual que está editando la tarea.
     */
    public Usuario usuario = new Usuario(0, null, null, null, null);
    
    /**
     * Ruta al directorio principal del usuario en el sistema operativo.
     */
    ...
    /**
     * Ruta al archivo donde se guardan las listas de tareas.
     */
    private String listaTareas = userHome + "\\Taskflow\\Tareas";
    
    /**
     * Representa al usuario actualmente activo en el sistema.
     */
    private Usuario UsuarioActual = new Usuario();
    
    /**
     * Lista que contiene las tareas encontradas en la búsqueda.
     */
    public ArrayList<Tarea> listaBuscar;
    
    /**
     * Índice que indica la posición actual de la tarea seleccionada en la lista.
     */
    public int indice = 0;
    
    /**
     * Objeto de la clase MisTareas desde la cual es abierta esta ventana.
     */
    public MisTareas misTareas;

    /**
    * Establece las rutas de las tareas para el usuario actual.
    * Actualiza las rutas de directorio y lista de tareas según el ID del usuario actual.
    */
    ...
    /**
    * Establece la lista de tareas a partir de una lista proporcionada.
    * 
    ...
    */
    ...
    /**
    * Establece el índice de la tarea seleccionada.
    * Actualiza el índice y luego carga los detalles de la tarea actual.
    * 
    * @param i El índice de la tarea seleccionada en la lista de tareas.
    */
    ...
    /**
    * Muestra los detalles de la tarea actual en los campos de la interfaz.
    * Utiliza el índice para obtener la tarea de la lista y actualizar los componentes gráficos.
    */
    ...
    /**
    * Constructor de la clase EditarTareaPropia.
    * Inicializa la interfaz gráfica, establece la ubicación de la ventana,
    * configura los componentes y las rutas necesarias para el manejo de tareas.
    * 
    * @param misTareas Objeto de la Clase MisTareas desde la cual es llamada esta ventana.
    */
    public EditarTareaPropia(MisTareas misTareas) {
        initComponents();
    ...
    private void initComponents() {
        ...
        PRRegistro.add(CBMes, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 190, 40));
        ...
        PRRegistro.add(CBPrioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 200, 40));
        ...
        PRRegistro.add(CBEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(363, 250, 200, 40));
        ...
        PRRegistro.add(CBDia, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, 90, 40));
    ...
    /**
    * Evento disparado cuando el usuario hace clic en el campo de texto TF_Nombre.
    * Si el campo de texto contiene el nombre de la tarea actual, se borra el texto 
    * para permitir que el usuario ingrese un nuevo nombre.
    * 
    * @param evt El evento de mouse que se dispara al hacer clic en el campo de texto.
    */
    ...
    /**
    * Evento disparado cuando el usuario hace clic en el campo de texto TF_Descripcion.
    * Si el campo de texto contiene la descripción de la tarea actual, se borra el texto
    * para permitir que el usuario ingrese una nueva descripción.
    * 
    * @param evt El evento de mouse que se dispara al hacer clic en el campo de texto.
    */
    ...
    /**
    * Evento que se ejecuta cuando el usuario hace clic en el botón para editar una tarea.
    * Este método valida los campos de entrada y, si son válidos, actualiza la tarea
    * seleccionada con los nuevos valores proporcionados por el usuario.
    * Luego guarda la tarea editada en el archivo correspondiente y actualiza la lista de tareas.
    * 
    * @param evt El evento de acción que se dispara al hacer clic en el botón de editar tarea.
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarTareaPropia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarTareaPropia(misTareas).setVisible(true);
            }
        });
    }
