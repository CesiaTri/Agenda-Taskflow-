 ...
 * La clase proporciona funcionalidades para buscar tareas y mostrar sus detalles en una interfaz gráfica.
 */
public class Historial extends javax.swing.JFrame {
    ...
    */
    ...
    /**
    * Ruta para el archivo de tareas de un usuario específico.
    */
    ...
    */
    ...
    /**
    * Lista utilizada para almacenar las tareas filtradas o que cumplen con ciertos criterios de búsqueda.
    */
    ...
    * Inicializa los componentes de la interfaz gráfica y ajusta las imágenes en los labels utilizando la clase Escalar.
    * Además, obtiene el usuario actual, carga las tareas completadas del usuario y las muestra en la interfaz.
    */
    public Historial() {
        initComponents();
    ...
    /**
    * Método que busca una tarea específica en la lista de tareas.
    * Compara el número de tarea y el nombre de la tarea proporcionada con las tareas almacenadas en la lista.
    * 
    * @param buscar La tarea que se desea buscar en la lista.
    * @return La tarea encontrada, o una tarea vacía si no se encuentra en la lista.
    */
    ...
    /**
    * Método que establece la lista de tareas, filtrando solo aquellas que están completadas.
    * Además, limpia la tabla actual y vuelve a cargar la lista de tareas filtrada, 
    * o ejecuta una búsqueda si los filtros de nombre, prioridad o estado están configurados.
    */
    ...
    /**
    * Método que vacía la tabla eliminando todas las filas de la misma.
    * Recorre las filas de la tabla desde la última hasta la primera y las elimina.
    */
    ...
    /**
    * Método que rellena la tabla con los datos de la lista de tareas proporcionada.
    * Itera sobre la lista de tareas y agrega cada tarea como una nueva fila en la tabla.
    * 
    * @param lista La lista de tareas que se mostrará en la tabla.
    */
    ...
    /**
    * Filtra las tareas de la lista según los criterios proporcionados: texto de búsqueda, prioridad seleccionada
    * y estado seleccionado.
    * 
    * @param textoBusqueda El texto utilizado para buscar tareas por nombre.
    * @param prioridadSeleccionada La prioridad seleccionada para filtrar tareas.
    * @param estadoSeleccionado El estado seleccionado para filtrar tareas.
    ...
    */
    ...
    /**
    * Realiza una búsqueda de tareas aplicando los filtros de nombre, prioridad y estado seleccionados.
    * Luego actualiza la tabla con los resultados de la búsqueda.
    */
    ...
    private void initComponents() {
        ...
        Pantalla.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 650, 350));
        ...
        Pantalla.add(BTReiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 550, 110, 40));
        ...
        Pantalla.add(BTVaciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 550, 130, 40));
    ...
    /**
     * Método que se ejecuta cuando el usuario presiona el botón de búsqueda en la interfaz gráfica.
     * Llama al método `buscarTarea()` para realizar la búsqueda de tareas basándose en los filtros seleccionados.
     * 
     * @param evt El evento generado por el click del usuario sobre el botón de búsqueda.
     */
     ...
     * Este método limpia los filtros de búsqueda, vacía la tabla y luego la rellena con todas las tareas de la lista.
     * Además, restablece los valores predeterminados en los campos de búsqueda.
     * 
     * @param evt El evento generado por el click del usuario sobre el botón de reiniciar.
     */
    ...
    /**
    * Método que se ejecuta cuando el usuario hace clic en el campo de texto de búsqueda.
    * Si el texto en el campo es el valor predeterminado "Buscar por nombre", lo borra para permitir al usuario ingresar un nuevo texto.
    * 
    * @param evt El evento generado por el click del usuario sobre el campo de texto de búsqueda.
    */
    ...
    /**
    * Método que se ejecuta cuando el usuario cambia la selección en el combo box de prioridad.
    * Llama al método `buscarTarea()` para realizar la búsqueda de tareas según la prioridad seleccionada.
    * 
    * @param evt El evento generado cuando el usuario cambia la selección en el combo box de prioridad.
    */
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón de vaciar (eliminar todas las tareas).
    * Este método elimina todas las tareas de la lista del usuario, tanto en la interfaz como en los archivos correspondientes.
    * Después de eliminar las tareas, actualiza la lista, restablece los filtros y muestra un mensaje de confirmación.
    * 
    * @param evt El evento generado por el click del usuario sobre el botón de vaciar.
    */
    ...
    /**
    * Método que agrega una nueva fila a la tabla con datos y botones de acción para editar, eliminar y ver detalles.
    * 
    * Este método realiza varias acciones:
    * 1. Agrega la fila a la tabla con los datos proporcionados en el arreglo `rowData`.
    * 2. Configura los eventos para los botones de acción de la fila (editar, eliminar y ver) en la última columna.
    * 3. Asocia los eventos de acción con los botones de la fila, permitiendo interactuar con las tareas en la tabla.
    * 4. Muestra una ventana de edición cuando se hace clic en el botón de editar, elimina la tarea cuando se hace clic en el botón de eliminar y muestra los detalles de la tarea cuando se hace clic en el botón de ver.
    * 
    * @param rowData Un arreglo de objetos que contiene los datos de la fila que se va a agregar a la tabla.
    */
    ...
    TableActionEvent event = new TableActionEvent() {
        ...
        public void onEdit(int row) {
            ...
            if (selectedRow != -1) {
                ...
                EditarTareaCompletada ventana= new EditarTareaCompletada(Historial.this);
