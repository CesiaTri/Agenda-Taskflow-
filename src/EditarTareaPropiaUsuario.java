 ...
 * Esta clase permite al usuario editar los detalles de sus propias tareas.
 */
public class EditarTareaPropiaUsuario extends javax.swing.JFrame {
    ...
    /**
     * Objeto de la Clase MisTareasUsuario desde la cual es llamada esta ventana.
     */
    public MisTareasUsuario misTareasUsuario;

    /**
    * Establece las rutas de las tareas y la lista de tareas del usuario actual.
    */
    ...
    /**
     * Establece la lista de tareas que se mostrarán o manipularán en la interfaz.
     * 
     * @param list La lista de tareas que se asignará a la variable listaBuscar.
     */
    ...
    /**
    * Establece el índice de la tarea seleccionada y luego muestra los detalles de la tarea
    * actual en los campos de la interfaz.
    * 
    ...
    */
    ...
    /**
    * Muestra los detalles de la tarea seleccionada en los campos de la interfaz.
    * El nombre, descripción, día, mes, estado, prioridad y año de la tarea se muestran
    ...
    */
    ...
    /**
    * Constructor de la clase EditarTareaPropiaUsuario.
    * Inicializa los componentes gráficos, establece la ubicación de la ventana en el centro
    * y ajusta las rutas a las tareas del usuario actual. También configura el fondo de la
    * interfaz y obtiene el usuario actualmente activo.
    * 
    * @param misTareasUsuario Objeto de la Clase MisTareasUsuario desde la cual es llamada esta ventana.
    */
    ...
    /**
    * Maneja el evento de acción cuando se hace clic en el botón de editar tarea.
    * Este método valida los campos de entrada del usuario, crea una nueva tarea
    * con los datos proporcionados y la guarda en el archivo correspondiente. También
    * actualiza la lista de tareas del usuario.
    * 
    * Si algún campo está vacío o no se ha seleccionado correctamente, se muestra un mensaje
    * de advertencia al usuario.
    * 
    * @param evt El evento de acción generado por el botón de editar tarea.
    */
    ...
    /**
    * Maneja el evento de presión del ratón en el campo de texto de descripción.
    * Si el campo de texto contiene el valor predeterminado (es decir, la descripción actual
    * de la tarea), se borra el texto al hacer clic en el campo, permitiendo al usuario
    * ingresar una nueva descripción para la tarea.
    * 
    * @param evt El evento de presión del ratón sobre el campo de texto de descripción.
    */
    ...
    /**
    * Maneja el evento de presión del ratón en el campo de texto de nombre.
    * Si el campo de texto contiene el valor predeterminado (es decir, el nombre actual
    * de la tarea), se borra el texto al hacer clic en el campo, permitiendo al usuario
    * ingresar un nuevo nombre para la tarea.
    * 
    * @param evt El evento de presión del ratón sobre el campo de texto de nombre.
    */
