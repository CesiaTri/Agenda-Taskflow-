...
/**
 * Clase que representa la ventana principal de la interfaz de usuario para las tareas de un usuario en la aplicación Taskflow.
 * Proporciona funcionalidades para visualizar, filtrar, editar y eliminar tareas.
 */
public class MisTareasUsuario extends javax.swing.JFrame {

     /** 
     * Objeto Escalar para realizar operaciones de escala en tareas o procesos.
     */
    private Escalar escalar = new Escalar();

    /** 
     * Objeto Usuario que representa al usuario actual que maneja las tareas.
     */
    private Usuario UsuarioActual = new Usuario();

    /** 
     * Ruta del directorio principal del usuario en el sistema de archivos.
     * Esto se utiliza para gestionar las ubicaciones de archivos del usuario.
     */
    private String userHome = "C:\\Users\\Cesia\\Desktop";

    /** 
     * Ruta donde se guardan las tareas del usuario. Este archivo contiene una lista de tareas asignadas al usuario.
     */
    private String fileListaTareas = userHome + "\\Taskflow\\Tareas\\Usuario";

    /** 
     * Directorio donde se almacenan las tareas del usuario en el sistema de archivos.
     */
    private String direcTareas = userHome + "\\Taskflow\\Tareas\\Usuario";

    /** 
     * Lista que contiene todas las tareas asociadas al usuario.
     * Se utilizan objetos de la clase Tarea para representar cada tarea individual.
     */
    public ArrayList<Tarea> lista;

    /** 
     * Lista auxiliar que se utiliza para almacenar las tareas durante las búsquedas.
     * Ayuda en la manipulación de tareas que cumplen ciertos criterios de búsqueda.
     */
    public ArrayList<Tarea> listaBuscar = new ArrayList<>();

    /** 
     * Nombre de la tarea o del usuario que se está procesando en el sistema.
     * Es una variable que puede cambiar según el contexto de la operación.
     */
    public String nombre = "";

    /** 
     * Prioridad asignada a la tarea.
     * Este valor puede ser utilizado para clasificar o ordenar tareas de acuerdo a su urgencia.
     */
    public String prioridad = "";

    /** 
     * Estado actual de la tarea.
     * Los valores posibles incluyen "pendiente", "en progreso", "completada", etc.
     */
    public String estado = "";

    /** 
     * Índice de la tarea seleccionada en la lista.
     * Este valor se utiliza para acceder a una tarea específica dentro de la lista.
     */
    public int indice = 0;

    /** 
     * Contador que lleva el seguimiento del número total de tareas.
     * Se incrementa a medida que se agregan tareas o se realiza alguna operación relacionada.
     */
    public int cont = 0;
    
    /**
     * Constructor de la clase MisTareasUsuario. Inicializa los componentes de la interfaz
     * y configura las imágenes y la lista de tareas del usuario.
     */
    public MisTareasUsuario() {
        initComponents();
    ...
    /**
    * Este método obtiene la tarea correspondiente de la lista de tareas
    * basándose en el número de tarea y el nombre. Si encuentra la tarea
    * que coincide con los criterios, la devuelve, y también guarda el índice
    * de la tarea encontrada en la lista.
    *
    * @param buscar Tarea con el número y nombre a buscar
    * @return Tarea encontrada en la lista o una tarea vacía si no se encuentra
    */
    ...
    /**
    * Este método actualiza la lista de tareas, recarga las tareas desde el archivo
    * y filtra aquellas que están marcadas como "Completada".
    * Luego, actualiza la tabla dependiendo de si se aplicaron filtros.
    */
    ...
    /**
    * Este método vacía la tabla eliminando todas las filas actuales.
    */
    ...
    /**
    * Este método llena la tabla con las tareas proporcionadas en la lista.
    * Para cada tarea, agrega una fila con los detalles de la tarea y un botón de acción adicional.
    *
    * @param lista Lista de tareas a mostrar en la tabla
    */
    ...
    /**
    * Este método filtra las tareas según el texto de búsqueda, la prioridad y el estado seleccionados.
    *
    * @param textoBusqueda Texto a buscar en los nombres de las tareas
    * @param prioridadSeleccionada Prioridad seleccionada en el filtro
    * @param estadoSeleccionado Estado seleccionado en el filtro
    * @param lista Lista de tareas que se va a filtrar
    ...
    */
    ...
    /**
    * Este método se encarga de ejecutar la búsqueda de tareas en función de los filtros seleccionados
    * (nombre, prioridad y estado) y actualizar la tabla con los resultados.
    */
    ...
    private void initComponents() {
        ...
        Pantalla.add(BTBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 120, 110, 40));
        ...
        CBEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estado", "Por hacer", "En progreso" }));
        ...
        Pantalla.add(CBEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 140, -1));
        ...
        Pantalla.add(CBPrioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 180, -1, -1));
        ...
        Pantalla.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 240, 650, 300));
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón de reiniciar.
    * Este método restablece los valores predeterminados de la interfaz de usuario
    * y limpia los datos relacionados con las tareas mostradas.
    * 
    * @param evt El evento de clic del ratón que provoca la ejecución del método.
    */
    ...
    /**
    * Método que se ejecuta cuando cambia el estado seleccionado en el combo de estado.
    * Si el usuario selecciona un nuevo estado, se invoca la función de búsqueda para actualizar los resultados.
    * 
    * @param evt El evento de cambio de estado en el combo de selección de estado.
    */
    private void CBEstadoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CBEstadoItemStateChanged
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            buscarTarea();  // Llama a la función de búsqueda para actualizar los resultados
        }
    }//GEN-LAST:event_CBEstadoItemStateChanged

    /**
    * Método que se ejecuta cuando cambia el estado seleccionado en el combo de prioridad.
    * Si el usuario selecciona una nueva prioridad, se invoca la función de búsqueda para actualizar los resultados.
    * 
    * @param evt El evento de cambio de estado en el combo de selección de prioridad.
    */
    ...
    private void BTCrearTareaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTCrearTareaMousePressed
        CrearTareaUsuario ventana = new CrearTareaUsuario();
        ventana.setVisible(true);
        this.dispose();
    ...
    /**
    * Método que se ejecuta cuando el usuario presiona el botón para vaciar las tareas.
    * Este método elimina todas las tareas almacenadas, actualiza la lista y restablece los valores de la interfaz.
    * 
    * @param evt El evento de clic del ratón que activa la ejecución del método.
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MisTareasUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        */
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MisTareasUsuario().setVisible(true);
            }
        });
    }
    
    /**
    * Agrega una nueva fila a la tabla con los datos proporcionados y botones de acción.
    * Los botones de acción permiten realizar operaciones sobre las filas como editar, eliminar y ver detalles.
    * 
    * @param rowData Los datos de la fila que se agregará a la tabla. Este arreglo contiene los valores de cada columna.
    */
    ...
    TableActionEvent event = new TableActionEvent() {
        ...
        public void onEdit(int row) {
            ...
            if (selectedRow != -1) {
                ...
                EditarTareaPropiaUsuario ventana= new EditarTareaPropiaUsuario(MisTareasUsuario.this);
